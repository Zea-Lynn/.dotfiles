...
--Wow are automatic comments anoying.
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'html', 'javascript', 'css', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx',
    'typescript', 'vimdoc', 'vim', 'c_sharp', 'odin', 'glsl' },
